...
df_ddos = pd.read_csv(
    "./Trafego/Friday-WorkingHours-Afternoon-DDos.pcap_ISCX.csv",
...
df_portscan = pd.read_csv(
    "./Trafego/Friday-WorkingHours-Afternoon-PortScan.pcap_ISCX.csv",
    skiprows=range(1, 87794),
    nrows=linhas_para_ler
)
df_normal = pd.read_csv(
    "./Trafego/Wednesday-workingHours.pcap_ISCX.csv",
    skiprows=range(1, 2),
    nrows=linhas_para_ler
)
